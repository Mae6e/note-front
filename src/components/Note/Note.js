...
import './Note.css';
import btnSave from '../../constants/accept.png';
...
const Note = (props) => {
  ...
  }, [props.style.transform, readOnly]);
        ...
        {!readOnly ? (
          <div>
            <button onClick={onCancelHandler}>
              <img src={btnEraser} alt="eraser" />
            </button>
            <button onClick={props.value.id === undefined ? onSaveHandler : onEditHandler}>
